...
public class JugsState extends SearchState{
 ...
 //remove all comments which end in 'd'
  public ArrayList<SearchState> getSuccessors (Search searcher) {
    JugsSearch jsearcher = (JugsSearch) searcher;
    int cap1=jsearcher.getCap1(); //capacity of first jug 'd'
    int cap2=jsearcher.getCap2();// capacity of second'd'
    int j1Space=cap1-j1; //how much space is left in first jug 'd'
    int j2Space=cap2-j2;//how much space is left in second jug 'd'
